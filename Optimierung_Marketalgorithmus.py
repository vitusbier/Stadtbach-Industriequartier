...
class Optimierung_Marktalgotithmus():
        ...
        def run_model(self, i):
            ...
            if self.m.Status == GRB.OPTIMAL:
                ...
                results = [value_target, i, self.p, self.vol.x, self.vol_d_MAN.x, self.vol_s_MAN.x, self.vol_d_MTA.x, self.vol_s_MTA.x, self.vol_d_UPM.x, self.vol_s_UPM.x, self.vol_d_storage.x, self.vol_s_storage.x, self.epsilon_average_q]
