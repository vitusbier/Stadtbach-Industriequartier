...
class Storage(mesa.Agent):
        ...
        def setup_model(self):
            ...
            for j in rti:
                if j==0:
                    self.m.addConstr(self.level_t_post[j]==self.level_t0, name=f'set_level_t_0_{j}')
            ...
            self.m.addConstr(self.level_t_post[len(rti)-1]==self.level_T, name='set_level_last_periode')
